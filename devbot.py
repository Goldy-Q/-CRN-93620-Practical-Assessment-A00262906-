...
if choice.lower() == 'n':
	...
	accessToken = "Bearer your_hard_coded_token"
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "jFFa7MbD7E8fEq6T9w6ZzQJHqQPdXdsl"
                               }
...
# 11. Complete the code to format the response message.
        responseMessage = "In {} the sun will rise at {} and will set at {} . The day will last {} seconds.".format(location, sunrise, sunset, duration)

        print("Sending to Webex Teams: " +responseMessage)

# 12. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": YTc3MDFmNGEtNTJjNS00MzBjLTkxMzYtYTAwYzk2NzMxMjg5M2FhNDczNGYtNWIz_PC75_47fe537e-27d1-4e32-b2dc-2c26e4aa4fa0,
                             "Content-Type": "application/json"
                           }
        PostData = {
                            "roomId": https://meet265.webex.com/meet/pr27744781636,
                            "text": Hello
                        }
